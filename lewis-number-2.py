...
plt.savefig('lewis_number_contour.png')
plt.close()
...
# Plot the surface, with Dm_grid and Lambda_grid reordered to change the axis display
surf = ax.plot_surface(Dm_grid, Lambda_grid, Le_grid, cmap=cm.viridis,
...
ax.set_xlabel(r'Mass Diffusivity, $D_m$ (m²/s)', fontsize=12, labelpad=10)
ax.set_ylabel(r'Thermal Conductivity, $\lambda$ (W/m·K)', fontsize=12, labelpad=10)
